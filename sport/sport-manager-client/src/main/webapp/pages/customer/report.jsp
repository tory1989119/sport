...
<head>
    ...
    <title>报名俱乐部</title>
        ...
        $(function () {
            ...
            table = $('#example').DataTable({
                ...
                "ajax": {
                	...
                	"dataType": "json",
                    "url": '<%=request.getContextPath()%>/report/getlist.do'
                },
                "serverSide": true,
                "columns": [
                    {"data": "id"},
                ...
                "columnDefs": [
                    {
                        ...
                        "render": function (a, b, c, d) {
                            var html = "<button type=\"button\" class=\"btn btn-primary btn-smg\" onclick=\"edit('"+ c.id +"','"+ c.report +"','"+ c.reply +"')\">回复</button>";
        ...
        function ajax(obj) {
            url = "<%=request.getContextPath()%>/report/edit.do";
            $.ajax({
            	type: "post",
                url:url ,
                data: {
        ...
        function del(id) {
    		...
    		var option = {
    			...
    			onOk: function(){
    				$.ajax({
    					type: "post",
                        url: "<%=request.getContextPath()%>/report/delete.do",
                        data: {
                            "id": id
                        }, success: function (data) {
                            data = jQuery.parseJSON(data);
			            ...
			            <form id="defaultForm"  class="form-horizontal">
				            <div class="modal-body">
		                        ...
		                        <div class="form-group">
		                            <label class="col-lg-2 control-label">举报</label>
		                            <div class="col-lg-10">
		                            	<textarea class="form-control" id="report" name="report" style="width: 400px" disabled="disabled"></textarea>
		                            </div>
		                        </div>
		                        <div class="form-group">
